...
describe("bctToken", async function () {
  let user1: any, user2: any, user3: any, user4: any, user5: any, user6, user7: any, user8: any;
  ...
  before(async () => {
    ...
    cryptoTodayFutures = (await CryptoTodayFutures.deploy(supply.div(10).toString(), [
      ...
      { account: user3.address, amount: supply.div(30).toString() },
      { account: user4.address, amount: supply.mul(2).div(30).toString() },
      { account: user5.address, amount: supply.div(30).toString() },
      { account: user6.address, amount: supply.mul(2).div(30).toString() },
      { account: user7.address, amount: supply.div(30).toString() },
      { account: user8.address, amount: supply.mul(2).div(30).toString() },
    ])) as BCTFuture;
  ...
  describe("bct mint to", async function () {
